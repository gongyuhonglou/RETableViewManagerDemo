...
{
    [[UIApplication sharedApplication].keyWindow.rootViewController jxt_showAlertWithTitle:title message:message appearanceProcess:appearanceProcess actionsBlock:actionBlock];
}
...
+ (void)mj_showActionSheetWithTitle:(nullable NSString *)title
                  ...
                  appearanceProcess:(JXTAlertAppearanceProcess)appearanceProcess
                       actionsBlock:(nullable JXTAlertActionBlock)actionBlock NS_AVAILABLE_IOS(8_0)
{
    [[UIApplication sharedApplication].keyWindow.rootViewController jxt_showActionSheetWithTitle:title message:message appearanceProcess:appearanceProcess actionsBlock:actionBlock];
}
@end
